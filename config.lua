...
Config.CarGarages = {
	...
	Garage_Prison = {
		GaragePoint = { x = 1853.37, y = 2579.04, z = 44.67 },
	...
	Garage_Richman = {
		GaragePoint = { x = -1843.98, y = 88.06, z = 77.48 },
		SpawnPoint = { x = -1847.38, y = 85.05, z = 78.02, h = 224.48 },
		DeletePoint = { x = -1856.05, y = 81.26, z = 78.03 }
	},
--[[
	Garage_RumahMiyuEja =
	{
		--GaragePoint = { x = -102.29, y = 826.72, z = 234.72  },
		GaragePoint = { x = -102.72, y = 829.03, z = 234.66  },
		SpawnPoint = { x = -104.76, y = 834.45, z = 234.11, h = 9.99 },
		DeletePoint = { x = -103.75, y = 823.37, z = 234.15 },
		NoBlip = true,
		NoStoreBlip = true
	},

	Garage_RumahMikelFahry =
	{
		--GaragePoint = { x = -102.29, y = 826.72, z = 234.72  },
		GaragePoint = { x = -124.54, y = 1010.03, z = 234.73  },
		SpawnPoint = { x = -125.95, y = 993.57, z = 234.23, h = 152.96 },
		DeletePoint = { x = -110.87, y = 1004.9, z = 234.25 },
		NoBlip = true,
		NoStoreBlip = true
	},

	Garage_RumahHendrikRamboy =
	{
		--GaragePoint = { x = -102.29, y = 826.72, z = 234.72  },
		GaragePoint = { x =  -141.42, y = 907.21, z = 234.72 },
		SpawnPoint = { x = -133.4, y = 901.54, z = 234.21, h = 266.49 },
		DeletePoint = { x = -137.2, y = 902.36, z = 234.66 },
		NoBlip = true,
		NoStoreBlip = true
	}
]]--
